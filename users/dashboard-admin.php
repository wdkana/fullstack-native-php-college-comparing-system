		...
		<div class="navbar-fixed">
			<nav class="blue">
				<div class="nav-wrapper">
					<h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="../assets/images/materialize-logo.png" alt="Banding Kampus"></a> <span class="logo-text">Banding Kampus Untuk Admin</span></h1>
