    ...
    <section class="content">
       ...
       <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Kampus</h3>
              ...
              <table class="table table-stripped">
                ...
                <tbody>
                  <tr>
                      ...
                      <form action="process/ubahKampusProcess.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id?>">
                          <div class="form-group">
                            ...
                            <input type="text" name="nama_kampus" required placeholder="nama_kampus" value="<?php echo $row['nama_kampus']?>" class="form-control">
                          </div>
                            <div class="form-group">
                              <label>Alamat Kampus</label>
                              <input type="text" name="alamat" required placeholder="alamat" value="<?php echo $row['alamat']?>" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="slogan" rows="8" cols="70"><?php echo $row['slogan']?></textarea>
                            </div>
                            <div class="form-group">
                              <label>No HP</label>
                              <input type="number" name="no_hp" placeholder="no hp" value="<?php echo $row['no_hp']?>" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label>Fax</label>
                              <input type="text" name="fax" placeholder="fax" value="<?php echo $row['fax']?>" class="form-control">
                            </div>
                            <h2>Sosial Media</h2>
                            <div class="form-group">
                              <label>Instagram</label>
                              <input type="text" name="instagram" placeholder="instagram" value="<?php echo $row['instagram']?>" class="form-control">
                            </div>
                            <div class="form-group">
                              <label>Facebook</label>
                              <input type="text" name="facebook" placeholder="facebook" value="<?php echo $row['facebook']?>" class="form-control">
                            </div>
                            <div class="form-group">
                              <label>Twitter</label>
                              <input type="text" name="twitter" placeholder="twitter" value="<?php echo $row['twitter']?>" class="form-control">
                            </div>
                            <div class="form-group">
                              <label>Website</label>
                              <input type="text" name="website" placeholder="website" value="<?php echo $row['website'];?>" class="form-control">
                            </div>
                            <div class="form-group">
                              <input type="submit" name="simpan" value="simpan" class="btn btn-flat btn-success btn-sm">
                            </div>
                    ...
                    <td>
                        <br>
                         <img src="../../assets/images/<?php echo $row['foto'];?>" width="400" height="400">
                    </td>
                  </tr>
                </tbody>
              </table>
