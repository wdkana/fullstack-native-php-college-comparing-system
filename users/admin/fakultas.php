    ...
    <section class="content">
       <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Fakultas Kampus <?php echo $row['nama_kampus'];?></h3>
          ...
          <div class="row">
            <div class="col-md-12">
               <form action="process/fakultasProcess.php" method="post">
                  ...
                  <div class="form-group">
                  	<input type="submit" value="Simpan" class="btn btn-flat btn-sm btn-success">
                  </div>
                </form>                             
            </div>
            <!-- /.col -->
            ...
            <div class="col-md-12">
              <table class="table table-stripped" id="example1">
                  ...
                  <tbody>
                    <?php
                        $no = 1;
                        while($row = mysql_fetch_array($resultFakultas)){
                    ?>
                    <tr>
                      <td><?php echo $no;?></td>
                      <td><?php echo $row['nama_kampus'];?></td>
                      <td><?php echo $row['fakultas'];?></td>
                      <td><a href="editFakultas.php?i=<?php echo $row['id']?>" class="btn btn-flat btn-sm btn-success">Ubah</a>
                      <button onclick="hapus(<?php echo $row['id']?>)" class="btn btn-flat btn-sm btn-danger">Hapus</button></td></td>
                    </tr>
                    <?php
                        $no++;
                      }
...
<script>
      function hapus(id, idk) {
            ...
            if (r == true) {
                window.location.href="process/deleteFakultasProcess.php?i="+id;
            } else {
