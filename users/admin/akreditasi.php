                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <h4>
                        Support Team
                        <small><i class="fa fa-c  lock-o"></i> 5 mins</small>
                      </h4>
    ...
    <section class="content">
       <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Akreditasi Kampus <?php echo $result['nama_kampus'];?></h3>
          ...
          <div class="row">
            <div class="col-md-12">
               <form action="process/akreditasiProcess.php" method="post">
                  ...
                  <input name="nama_kampus" type="hidden" value="<?php echo $result['nama_kampus']?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="akreditasi" placeholder="akreditasi" class="form-control">
                  </div>
                  <div class="form-group">
                    <input type="submit" value="simpan" class="btn btn-sm btn-flat btn-flat btn-success">  
                  </div>
                </form>                             
            </div>
            <!-- /.col -->
              ...
              <table class="table table-stripped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="ubahAkreditasi.php?i=<?php echo $row['id']?>&id=<?php echo $id?>" class="btn btn-flat btn-sm btn-success">Ubah</a>
                      <button onclick="hapus(<?php echo $row['id']?>, <?php echo $id?>)" class="btn btn-flat btn-sm btn-danger">Hapus</button></td></td>
                    </tr>
                    <?php
                        $no++;
                      }
