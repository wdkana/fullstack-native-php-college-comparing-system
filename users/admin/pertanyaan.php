    ...
    <section class="content">
       <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Pertanyaan Survei</h3>
            ...
            <div class="col-md-12">
                <form action="process/pertanyaanProcess.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="pertanyaan" required placeholder="Pertanyaan" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 1</label>
                        <input type="text" name="pil1" required placeholder="Pilihan 1" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 2</label>
                        <input type="text" name="pil2" required placeholder="Pilihan 2" class="form-control">
                    </div>
                    <div class="form-group">
                       <label>Pilihan 3</label>
                        <input type="text" name="pil3" required placeholder="Pilihan 3" class="form-control">
                    </div>
                    <div class="form-group">
                       <label>Pilihan 4</label>
                        <input type="text" name="pil4" required placeholder="Pilihan 4" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 5</label>
                        <input type="text" name="pil5" required placeholder="Pilihan 5" class="form-control">
                    </div>
                    <div class="form-group">
                ...
                <table class="table table-stripped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="edit_pertanyaan.php?id=<?php echo $row['id'];?>" class="btn btn-flat btn-sm btn-success">Edit</a>
