                ...
                <form action="process/ubahPertanyaanProcess.php" method="post">
                    ...
                    <div class="form-group">
                      <label>Pertanyaan</label>
                        <input type="text" name="pertanyaan" required placeholder="Pertanyaan" value="<?php echo $row['pertanyaan'];?>" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 1</label>
                        <input type="text" name="pil1" required placeholder="Pilihan 1" value="<?php echo $row['pil1'];?>" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 2</label>
                        <input type="text" name="pil2" required placeholder="Pilihan 2" value="<?php echo $row['pil2'];?>" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 3</label>
                        <input type="text" name="pil3" required placeholder="Pilihan 3" value="<?php echo $row['pil3'] ;?>" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Pilihan 4</label>
                        <input type="text" name="pil4" required placeholder="Pilihan 4" value="<?php echo $row['pil4'] ;?>" class="form-control">
                    </div>
                    <div class="form-group">
                       <label>Pilihan 5</label>
                        <input type="text" name="pil5" required placeholder="Pilihan 5" value="<?php echo $row['pil5'] ;?>" class="form-control">
                    </div>
                    <div class="form-group">
                       <input type="submit" name="simpan" value="Simpan" class="btn btn-sm btn-flat btn-success">
                    </div>
                  </form>
            </div>
            <!-- /.col -->
