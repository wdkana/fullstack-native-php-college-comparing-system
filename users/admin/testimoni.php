                  ...
                  <table class="table table-stripped" id="example1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="editTestimoni.php?id=<?php echo $row['id'];?>" class="btn btn-flat btn-sm btn-default">Edit</a>
                            <button onclick="hapus(<?php echo $row['id'];?>)" class="btn btn-flat btn-sm btn-danger">Hapus</button>
                        </td>
                      </tr>
                      <?php
                          $no++;
